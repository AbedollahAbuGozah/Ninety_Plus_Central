...
<div
    ...
    <header>
        <table style="width: 100%;">
            ...
            <tr style="height: 0;">
                <td>
                    <img alt="ninetyPlus" style="border-radius: 10px" src="{{ asset('logos/ninetyPlus.jpg') }}"
                         height="30px"/>
                </td>
    ...
    <main>
        <div
            ...
            <div style="width: 100%; max-width: 489px; margin: 0 auto;">
                <img style="margin: 0 auto; padding: 0; border-radius: 10px" alt="ninetyPlus"
                     src="{{ asset('logos/ninetyPlus.jpg') }}" height="120px"/>
                ...
                <p style="margin: 0; padding: 3rem">
                    ...
                    @if(isset($actionUrl))
                        <a href="{{$actionUrl}}"
                           style="display: inline-block; padding: 10px 20px; font-size: 16px; color: #fff; background-color: orange; text-decoration: none; border-radius: 5px;">Verify
                            your account</a>
                    @endif
