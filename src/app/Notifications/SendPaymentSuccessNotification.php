...
class SendPaymentSuccessNotification extends Notification implements ShouldQueue
{
    use Queueable;
     ...
     */
    public function __construct($purchasable, protected $productName)
    {
    ...
    {
        return sprintf(
            'We are delighted to inform you that your payment was successful! Thank you for your purchase. You can now access %s.
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'purchasable_price' => $this->purchasable->price,
        ];
    }
}
